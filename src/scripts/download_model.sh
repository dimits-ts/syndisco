...
download_if_not_exists "$SRC_DIR/models/llama-3-8B.gguf" "https://huggingface.co/QuantFactory/Meta-Llama-3-8B-GGUF/resolve/main/Meta-Llama-3-8B.Q4_K_M.gguf?download=true"
